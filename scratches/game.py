...
def start():
    ...
    def play(button):
        ...
        if (button1["text"] == "X" and button2["text"] == "X" and button3["text"] == "X" or
            ...
            answer = tkinter.messagebox.askquestion('Gracz X wygrywa!', 'Chcesz, aby zagrać jeszcze raz ')
            tk.destroy()
            if answer == 'yes': start()
            ...
            answer = tkinter.messagebox.askquestion('Gracz O wygrywa!', 'Chcesz, aby zagrać jeszcze raz ')
            tk.destroy()
            if answer == 'yes': start()
